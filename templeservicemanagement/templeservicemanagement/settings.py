"""
Django settings for templeservicemanagement project.
...
STRIPE_PUBLIC_KEY = 'your-stripe-public-key'  # For frontend use
STRIPE_SECRET_KEY = 'your-stripe-secret-key'  # For backend use
